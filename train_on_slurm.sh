...
nvidia-smi
srun /gpfs/home/machnitz/miniconda3/envs/pytorch/bin/python main.py --gpus 2 --num_workers 20 --max_epochs 100 --data_path "/gpfs/work/machnitz/HIDA/HIDA-COVID/HackathonCovidData" --accelerator "ddp"